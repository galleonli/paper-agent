...
| **Check Run Status** | Shows run status for both scheduled (launchd) and manual runs: whether the daily schedule is installed, today's result, last successful day, and the most recent run metadata (mode, date, status, log path) with quick actions to open the log or state directory.                                                                                                                                                                                                                                                                          |
